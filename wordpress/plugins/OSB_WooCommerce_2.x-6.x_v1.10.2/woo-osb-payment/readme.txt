...
Tags: payment, OSB, gateway, checkout, credit card, bank card, e-commerce
...
This plugin links your WordPress WooCommerce shop to the OSB payment gateway.
...
1. Upload the folder `woo-osb-payment` to the `/wp-content/plugins/` directory
...
1. OSB general configuration.
2. OSB standard payment configuration.
3. OSB payment in installments configuration.
4. OSB payment options in checkout page.
5. OSB payment page.
...
* Added payment by token (requires OSB payment by token option).
...
* [multi] Compatibility with the OSB multi payment plugin.
