...
/**
 * Osb payment method integration
 *
 * @since 1.10.0
 */
final class WC_Gateway_Osb_Blocks_Support extends AbstractPaymentMethodType {
    /**
    ...
    public function get_payment_method_script_handles() {
        $asset_path   = WC_OSB_PLUGIN_PATH . '/build/index.asset.php';
        $version      = OsbTools::get_contrib();
        ...
        wp_register_script(
            ...
            WC_OSB_PLUGIN_URL . '/build/' . $this->name .'.js',
            $dependencies,
            $version,
            true
        );
    ...
    public function get_payment_method_data() {
        $data = array(
            ...
            'logo_url' => WC_OSB_PLUGIN_URL . 'assets/images/',
        );
