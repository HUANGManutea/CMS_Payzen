...
namespace Lyranetwork\Osb\Sdk\Form;
...
class Api
{
     ...
     *
     * @return array[int][Lyranetwork\Osb\Sdk\Form\Currency]
     */
    public static function getSupportedCurrencies()
    {
        $currencies = array(
            array('AUD', '036', 2), array('CNY', '156', 2), array('DJF', '262', 0), array('EUR', '978', 2),
            array('FJD', '242', 2), array('GBP', '826', 2), array('HKD', '344', 2), array('JPY', '392', 0),
            array('KHR', '116', 0), array('LAK', '418', 0), array('NZD', '554', 2), array('SBD', '090', 2),
            array('THB', '764', 2), array('USD', '840', 2), array('VUV', '548', 0), array('XPF', '953', 0)
        );
     ...
     *
     * @param string $alpha3
     * @return \Lyranetwork\Osb\Sdk\Form\Currency|null
     */
    public static function findCurrencyByAlphaCode($alpha3)
    {
        ...
        foreach ($list as $currency) {
            /**
             * @var \Lyranetwork\Osb\Sdk\Form\Currency $currency
             */
    ...
    public static function getSupportedCardTypes()
    {
        return array(
            ...
            'APETIZ' => 'Apetiz', 'BANCONTACT' => 'Bancontact Mistercash', 'CA_DO_CARTE' => 'CA DO Carte',
            'CHQ_DEJ' => 'Chèque Déjeuner', 'DINERS' => 'Diners', 'DISCOVER' => 'Discover', 'EDENRED' => 'Ticket Restaurant',
            'GOOGLEPAY' => 'Google Pay', 'JCB' => 'JCB', 'PAYPAL' => 'PayPal', 'PAYPAL_SB' => 'PayPal Sandbox',
            'PRV_BDP' => 'Banque de Polynésie', 'PRV_BDT' => 'Banque de Tahiti', 'PRV_OPT' => 'OPT',
            'PRV_SMART_CARD' => 'Smart Card', 'PRV_SOC' => 'Banque Socredo', 'PRV_SOC_GOLD' => 'Banque Socredo Gold',
            'PRV_SOC_VERTE' => 'Banque Socredo Verte', 'SODEXO' => 'Pass Restaurant'
        );
    }
