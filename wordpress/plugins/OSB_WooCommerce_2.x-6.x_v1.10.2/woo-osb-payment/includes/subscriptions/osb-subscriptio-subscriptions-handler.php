...
class Osb_Subscriptio_Subscriptions_Handler implements Osb_Subscriptions_Handler_Interface
{
    /**
     * {@inheritDoc}
    ...
    public function process_subscription_renewal($order, $response)
    {
        ...
        if ($renewal_order_id = (int) $subscription->last_order_id) { // Get last generated order.
            ...
            update_post_meta($renewal_order_id, 'Subscription amount', WC_Gateway_Osb::display_amount($response->get('sub_amount'), $currency_code));
